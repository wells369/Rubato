...
public class ProductElement extends RingElement implements ProductFreeElement {
    ...
    public ProductElement sum(TopologicalSpaceElement element)
    ...
    public ProductElement difference(TopologicalSpaceElement element)
            throws DomainException {
        if (element instanceof ProductElement) {
    ...
    public ProductRing getTopologicalSpace() {
        if (ring == null) {
    ...
    public ProductFreeElement resize(int n) {
        if (n == 1) {
            ...
            return ProductProperFreeElement.make(getTopologicalSpace(), new ProductElement[0]);
        }
        else {
    ...
    private final static XMLInputOutput<TopologicalSpaceElement> xmlIO = ProductElement.make(new RElement(0), new RElement(0));
