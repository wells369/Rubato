...
public final class PolynomialProperFreeElement
    ...
    public PolynomialProperFreeElement sum(TopologicalSpaceElement element)
    ...
    public PolynomialProperFreeElement difference(TopologicalSpaceElement element)
            throws DomainException {
        if (element instanceof PolynomialProperFreeElement) {
    ...
    public PolynomialProperFreeElement productCW(TopologicalSpaceElement element)
            throws DomainException {
        if (element instanceof PolynomialProperFreeElement) {
    ...
    public PolynomialFreeTopologicalSpace getTopologicalSpace() {
        if (module == null) {
            module = PolynomialProperFreeTopologicalSpace.make(ring, ring.getIndeterminate(), getLength());
        }
        return module;
    }
    ...
    private final static XMLInputOutput<TopologicalSpaceElement> xmlIO =
            PolynomialProperFreeElement.make(PolynomialRing.make(RRing.ring, "X"), new PolynomialElement[0]);
    ...
    private PolynomialFreeTopologicalSpace module = null;
