 ...
 */
public class TrigonometryMorphism extends TopologicalSpaceMorphism {
    ...
    public String getElementTypeName() { return "TrigonometryMorphism"; }
    ...
    public TrigonometryMorphism(TopologicalSpace domain, TopologicalSpace codomain) {
