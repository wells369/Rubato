 ...
 */
public class LimitMorphism extends TopologicalSpaceMorphism {
    ...
    public String getElementTypeName() { return "LimitMorphism"; }
    ...
    public LimitMorphism(TopologicalSpace domain, TopologicalSpace codomain) {
