...
public final class PolynomialRing
    ...
    public PolynomialFreeTopologicalSpace getNullTopologicalSpace() {
        return PolynomialProperFreeTopologicalSpace.make(this, 0);
    }
    ...
    public PolynomialFreeTopologicalSpace getFreeTopologicalSpace(int dimension) {
        return PolynomialProperFreeTopologicalSpace.make(this, dimension);
    }
    ...
    public PolynomialElement createElement(List<TopologicalSpaceElement> elements) {
        if (elements.size() == 1) {
        ...
        int i = 0;
        for (TopologicalSpaceElement e : elements) {
    ...
    public PolynomialElement cast(TopologicalSpaceElement element) {
        if (this.equals(element.getTopologicalSpace())) {
    ...
    public PolynomialElement parseString(String string) {
        ...
        int[] exp = new int[1];
        TopologicalSpaceElement[] factor = new TopologicalSpaceElement[1];
        Vector<TopologicalSpaceElement> terms = new Vector<TopologicalSpaceElement>(30);
        terms.setSize(1);
        int maxexp = 0;
        try {
    ...
    private boolean splitTerm(String s, int[] exp, TopologicalSpaceElement[] factor) {
    ...
    private final static XMLInputOutput<TopologicalSpace> xmlIO = PolynomialRing.make(RRing.ring, "X");
