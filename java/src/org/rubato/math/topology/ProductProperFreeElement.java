...
public final class ProductProperFreeElement
    ...
    public ProductProperFreeElement sum(TopologicalSpaceElement element)
    ...
    public ProductProperFreeElement sum(ProductProperFreeElement element)
            throws DomainException {
        if (getTopologicalSpace().equals(element.getTopologicalSpace())) {
            throw new DomainException(this.getTopologicalSpace(), element.getTopologicalSpace());
        }
    ...
    public ProductProperFreeElement difference(TopologicalSpaceElement element)
            throws DomainException {
        if (element instanceof ProductProperFreeElement) {
    ...
    public ProductProperFreeElement productCW(TopologicalSpaceElement element)
            throws DomainException {
        if (element instanceof ProductProperFreeElement) {
    ...
    public ProductFreeTopologicalSpace getTopologicalSpace() {
        if (module == null) {
            module = ProductProperFreeTopologicalSpace.make(getRing(), getLength());
        }
        return module;
    }
    ...
    public double[] fold(TopologicalSpaceElement[] elements) {
        ...
        for (int i = 0; i < elements.length; i++) {
            res[i] = elements[i].fold(new TopologicalSpaceElement[] { elements[i] });
        }
    ...
    public TopologicalSpaceElement fromXML(XMLReader reader, Element element) {
        ...
        TopologicalSpace module0 = reader.parseModule(childElement);
    ...
    private final static XMLInputOutput<TopologicalSpaceElement> xmlIO = new ProductProperFreeElement(null, null);
    ...
    private ProductFreeTopologicalSpace module = null;
