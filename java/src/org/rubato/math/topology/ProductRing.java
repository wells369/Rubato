...
import org.rubato.math.topology.ProductFreeTopologicalSpace;
import org.rubato.math.topology.ProductProperFreeTopologicalSpace;
...
public final class ProductRing
    ...
    public ProductFreeTopologicalSpace getNullTopologicalSpace() {
        return ProductProperFreeTopologicalSpace.make(this, 0);
    }
    ...
    public boolean hasElement(TopologicalSpaceElement element) {
        return equals(element.getTopologicalSpace());
    }


    public ProductFreeTopologicalSpace getFreeTopologicalSpace(int dimension) {
        return ProductProperFreeTopologicalSpace.make(this, dimension);
    }
    ...
    public ProductElement createElement(List<TopologicalSpaceElement> elements) {
    ...
    public ProductElement cast(TopologicalSpaceElement element) {
    ...
    public ProductElement parseString(String string) {
        ...
        if (s.matches(re)) {
            ...
            for (int i = 0; i < m.size(); i++) {
                factors0[i] = (RingElement)getFactor(i).parseString(m.get(i).trim());
                if (factors0[i] == null) {
                    return null;
                }
            }
