...
public final class PolynomialElement
    ...
    public PolynomialElement sum(TopologicalSpaceElement element)
    ...
    public PolynomialElement difference(TopologicalSpaceElement element)
            throws DomainException {
        if (element instanceof PolynomialElement) {
    ...
    public PolynomialRing getTopologicalSpace() {
        return ring;
    }
    ...
    public String stringRep(boolean ... parens) {
        if (isZero()) {
            ...
            if (getRing().getCoefficientRing() instanceof PolynomialRing ||
                    getRing().getCoefficientRing() instanceof RRing) {
                paren = true;
            }
    ...
    private final static XMLInputOutput<TopologicalSpaceElement> xmlIO =
            new PolynomialElement("X", new RElement(0));
    ...
    public static void main(String[] args) throws DomainException, DivisionException {
        PolynomialRing r = PolynomialRing.make(RRing.ring, "X");
        PolynomialElement p = r.parseString("X^2+(-1)");
        PolynomialElement q = r.parseString("-2*X+(-3)");
        PolynomialElement[] res = new PolynomialElement[2];
        System.out.println(q.exgcd(p, res));
