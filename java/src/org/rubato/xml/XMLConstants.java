...
public interface XMLConstants {
    ...
    public static final String TOPOLOGICALSPACE         = "TopologicalSpace";
    public static final String TOPOLOGICALSPACEELEMENT  = "TopologicalSpaceElement";
    public static final String TOPOLOGICALSPACEMORPHISM = "TopologicalSpaceMorphism";
    ...
    public static final String TOPOLOGICAL_SPACE_ATTR   = "TopologicalSpace";
